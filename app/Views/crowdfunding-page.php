            ...
            <div class="container">
                ...
                <div class="project-parent">
                    ...
                    <div class="project-image-parent">
                        <img src="<?php echo base_url("assets/images/project2.png")?>">
                        <div id="ribbon-container"
                            style="top: 240px;right: -15px;"
                        >
                            <p href="#" id="ribbon">Crowdfunding Site</p>
                        </div>
                    </div>
                    <div class="project-detail">
                        ...
                        <a href="https://sensational-tapioca-df81c1.netlify.app/" target="_blank">Live Preview</a>
                    </div>
                    <div class="project-image-parent gif">
                        <img src="<?php echo base_url("assets/images/gif/crowdfunding-page.gif") ?>">
                    </div>
                </div>
        </section>
